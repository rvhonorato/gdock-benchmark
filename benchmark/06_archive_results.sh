#!/bin/bash
# Compress or decompress results/<version>/ directories as .tar.xz archives.
#
# Usage:
#   ./06_archive_results.sh compress [version]    # compress one or all versions
#   ./06_archive_results.sh decompress <version>  # decompress a specific archive
